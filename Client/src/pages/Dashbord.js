...
//             <label>
//                 Sleep Duration:
//                 <input name="sleep_duration" onChange={handleChange} placeholder="Sleep Duration" required />
//             </label>
//             <br />
//             <label>
//                 BMI Category:
...
//             <label>
//                 Heart Rate:
//                 <input name="heart_rate" onChange={handleChange} placeholder="Heart Rate" required />
//             </label>
//             <br />
//             <label>
//                 Daily Steps:
//                 <input name="daily_steps" onChange={handleChange} placeholder="Daily Steps" required />
//             </label>
//             <br />
//             <label>
//                 Systolic BP:
//                 <input name="systolic_bp" onChange={handleChange} placeholder="Systolic BP" required />
//             </label>
//             <br />
